                                ...
                                <div class="swiper">
                                    <div class="swiper-wrapper">
                                        <div class="product-single-slide-item swiper-slide">
                                            <img src="assets/images/products/product-single-01.jpg" alt="Product single" width="694" height="728" />
                                        </div>
                                        <div class="product-single-slide-item swiper-slide">
                                            <img src="assets/images/products/product-single-02.jpg" alt="Product single" width="694" height="728" />
                                        </div>
                                        <div class="product-single-slide-item swiper-slide">
                                            <img src="assets/images/products/product-single-03.jpg" alt="Product single" width="694" height="728" />
                                        </div>
                                        <div class="product-single-slide-item swiper-slide">
                                            <img src="assets/images/products/product-single-04.jpg" alt="Product single" width="694" height="728" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-single-zoom">
                                        <div class="zoom">
                                            <a class="product-glightbox" href="assets/images/products/product-single-01.jpg" aria-label="zoom image"></a>
                                            <a class="product-glightbox" href="assets/images/products/product-single-02.jpg" aria-label="zoom image"></a>
                                            <a class="product-glightbox" href="assets/images/products/product-single-03.jpg" aria-label="zoom image"></a>
                                            <a class="product-glightbox" href="assets/images/products/product-single-04.jpg" aria-label="zoom image"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="swiper">
                                    <div class="swiper-wrapper">
                                        <div class="product-single-thumb-item swiper-slide">
                                            <img src="assets/images/products/product-single-01.jpg" alt="Product single" width="144" height="155" />
                                        </div>
                                        <div class="product-single-thumb-item swiper-slide">
                                            <img src="assets/images/products/product-single-02.jpg" alt="Product single" width="144" height="155" />
                                        </div>
                                        <div class="product-single-thumb-item swiper-slide">
                                            <img src="assets/images/products/product-single-03.jpg" alt="Product single" width="144" height="155" />
                                        </div>
                                        <div class="product-single-thumb-item swiper-slide">
                                            <img src="assets/images/products/product-single-04.jpg" alt="Product single" width="144" height="155" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="product-single-tab-description">
                                        ...
                                        <div class="product-single-tab-description-item">
                                            ...
                                            <p>
                                                <img src="assets/images/content-single-product-image-2.png" alt="Product Icon" width="150" height="33" loading="lazy" />
                                            </p>
                                        </div>
                                        <!-- Product Single Tab Description Item End -->
                                    </div>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <div class="product-single-tab-image">
                                        ...
                                        <div class="product-single-tab-image__image">
                                            <a class="glightbox" href="https://www.youtube.com/watch?v=I2P22HzEVjs&amp;ab_channel=LAStudio" aria-label="Video"></a>
                                            <img src="assets/images/content-single-product-image-1.jpg" alt="product-image" width="320" height="218" loading="lazy" />
                                        </div>
                                    </div>
                                    ...
                                    <ul class="comment-items">
                                        ...
                                        <li class="comment-item">
                                            <div class="comment-item__author">
                                                <img src="assets/images/user/user-1.jpg" alt="Author" width="90" height="90" loading="lazy" />
                                            </div>
                                        ...
                                        <li class="comment-item">
                                            <div class="comment-item__author">
                                                <img src="assets/images/user/user-2.jpg" alt="Author" width="90" height="90" loading="lazy" />
                                            </div>
                                            <div class="comment-item__content">
                                                <div class="comment-item__rating">
                                                    <span
                                        ...
                                        <li class="comment-item">
                                            <div class="comment-item__author">
                                                <img src="assets/images/user/user-3.jpg" alt="Author" width="90" height="90" loading="lazy" />
                                            </div>
                                            <div class="comment-item__content">
                                                <div class="comment-item__rating">
                                                    <span
